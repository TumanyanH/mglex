    ...
    <section class="hth_section">
        ...
        <div class="container" style="padding-bottom: 30px;">
            <div class="p-190 text-center" style="margin-top: 100px !important;">
                ...
                <p class="text-left line-height"><span style="color: #0620CE;">Ուշադրությո՛ւն.</span>  ՀՀ տարածքից վճարումները իրականացվում են բացառապես ՀՀ դրամով։
                    </p>
                ...
                <div class="flex_contant mb-15">
                    <div class="form_left">
                        <div class="form_control">
                            <label class="text-left">Անուն Ազգանուն *</label>
                            <input type="text" />
                        </div>
                        <div class="form_control">
                            <label class="text-left">Էլ. հասցե *</label>
                            <input type="text" />
                        </div>
                    ...
                    <div class="form_right">
                        <div class="form_control">
                            <label class="text-left">Ինչպես դիմել ինձ *</label>
                            <input type="text" >
                        </div>
                        <div class="form_control">
                            <label class="text-left">Հեռախոս *</label>
                            <input type="text" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form_control">
                    <label class="text-left">Մասնագիտություն *</label>
                    <input type="text" value=""/>
                </div>
                ...
                <div class="flex_contant mb-15">
                    <div class="form_left">
                        <div class="form_control">
                            <label class="text-left">Գիտական աստիճան</label>
                            <input type="text" />
                        </div>
                        <div class="form_control">
                            <label class="text-left">Հաստատություն *</label>
                            <input type="text" />
                        </div>
                    ...
                    <div class="form_right">
                        <div class="form_control">
                            <label class="text-left">Կոչում</label>
                            <input type="text" >
                        </div>
                        <div class="form_control">
                            <label class="text-left">Պաշտոն</label>
                            <input type="text" >
                        </div>
                    </div>
                </div>
                ...
                <div class="flex_contant mb-15">
                    <div class="form_left">
                        <div class="form_control">
                            <label class="text-left">Գաղտնաբառ *</label>
                            <input class="password_input" type="password" value="" /> 
                    ...
                    <div class="form_right">
                        <div class="form_control">
                            <label class="text-left">Կրկնել գաղտնաբառը *</label>
                            <input class="password_input" type="password" value="" /> 
                            <i class="far fa-eye show_pass"></i>
                        </div>
                    </div>
